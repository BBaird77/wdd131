document.addEventListener("DOMContentLoaded", () => {
    ...
    articles.forEach((item) => {
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            console.log(articles); // Check if the array is populated
            ...
            const mainContent = document.querySelector("maincontent");
        console.log(mainContent); // Should log the maincontent element
        
        
            // Check if maincontent exists to avoid errors
            if (!mainContent) {
                console.error('Main content section not found!');
                return;
            }
            ...
            articles.forEach((item) => {
                // Create wrapper for each article
                const articleWrapper = document.createElement("div");
                articleWrapper.classList.add("article-wrapper");
                ...
                // Append the article wrapper to the main content section
